...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'], # Add your templates directory here / Project-level templates
...
WSGI_APPLICATION = 'basic_django.wsgi.application' # WSGI application path for deployment


# https://docs.djangoproject.com/en/6.0/ref/settings/#databases
# Database Configuration (default SQLite)
# Database configuration - CHANGES based on DEBUG mode
if DEBUG:
# Development database (SQLite - simple file)
    DATABASES = {
        'default': {
    ...
    # Production database (PostgreSQL - robust)
    DATABASES = {
        'default': {
